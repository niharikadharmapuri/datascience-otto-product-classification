...
if MODE == 'cv':
    ...
    utils.write_blender_data(constants.BLEND_PATH, MODEL_NAME + '.csv', predictions)
    ...
    utils.save_submission(constants.DATA_SAMPLE_SUBMISSION_PATH,
                          os.path.join(constants.ENSEMBLE_PATH, MODEL_NAME + '.csv'),
                          predictions)
elif MODE == 'holdout':
